...
group('Parse 1k events', () => {
  ...
  bench('MicroDVD', () => parseMicroDVD(microdvd1k, 25))
...
group('Serialize 1k events', () => {
  ...
  bench('MicroDVD', () => toMicroDVD(doc1k, 25))
...
group('Parse 10k events', () => {
  ...
  bench('MicroDVD', () => parseMicroDVD(microdvd10k, 25))
...
group('Serialize 10k events', () => {
  ...
  bench('MicroDVD', () => toMicroDVD(doc10k, 25))
